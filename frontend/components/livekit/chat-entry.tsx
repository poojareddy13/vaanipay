...
export const ChatEntry = ({
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          'max-w-4/5 rounded-[20px] px-4 py-3',
          messageOrigin === 'local' 
            ? 'ml-auto bg-white text-black shadow-md border border-gray-200' 
            : 'mr-auto bg-white text-black shadow-md border border-gray-200'
        )}
      >
        {message}
      </span>
