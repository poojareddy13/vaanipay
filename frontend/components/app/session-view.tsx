...
export const SessionView = ({
  ...
  return (
    <section className="relative z-10 h-full w-full overflow-hidden" style={{ backgroundColor: '#FFFFFF' }} {...props}>
      {/* Chat Transcript */}
      <div
        className={cn(
      ...
      >
        ...
        <div className="relative mx-auto max-w-2xl pb-3 md:pb-12" style={{ backgroundColor: '#FFFFFF' }}>
